using Tyuiu.RubankoGV.Sprint2.Task1.V2.Lib;
namespace Tyuiu.RubankoGV.Sprint2.Task1.V2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* последовательность можно чередовать, использовать один раз в выражении) *");
